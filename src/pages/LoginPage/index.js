                ...
                <div className="loginPage">
                    <div className="container">
                        <Widget>
                            ...
                            <FormManager initialValues={{ inputLogin: "", inputSenha: ""}}
                                ...
                                <form onSubmit={ event => this.fazerLogin(event, values)} className="loginPage__form" action="/">
                                            <InputFormField
                                                id="inputLogin"
                                                label="Login: "
                                                type="text"
